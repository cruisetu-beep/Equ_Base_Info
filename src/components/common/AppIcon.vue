...
const ICONS = {
  ...
  snowflake:   `<path d="M12 2v20M17 5L7 19M9 5l10 14M20 12H4M14 3l-2 2-2-2M14 21l-2-2-2 2M21 14l-2-2 2-2M3 14l2-2-2-2M18.5 7.5L16.5 9l-1.5-2M5.5 16.5L7.5 15l1.5 2M8.5 7.5L10.5 9l1.5-2M15.5 16.5L13.5 15l-1.5 2"/>`,
